...
INITIAL_ACCOUNTS = [
    ('Banco do Brasil', '0229-1', '103420-5', 'Corrente', 12450.75, '08/06/2026 10:15'),
    ('Itaú Unibanco', '1421-2', '500004-9', 'Corrente', 45800.20, '08/06/2026 09:30'),
    ('BTG Pactual', '0001', '119716-4', 'Investimento', 150000.00, '08/06/2026 11:00'),
]
...
class Command(BaseCommand):
    help = 'Seed financeiro module (batches, billing, adjustments, bank accounts)'
    ...
    def handle(self, *args, **options):
        ...
        if not BankAccount.objects.exists():
            ...
            for idx, (bank, agency, number, acc_type, balance, updated) in enumerate(INITIAL_ACCOUNTS, start=1):
        ...
        self.stdout.write(self.style.SUCCESS('Financeiro seed completed.'))
